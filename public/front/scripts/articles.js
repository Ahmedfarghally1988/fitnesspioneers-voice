...
var Page = 2;
    ...
    var handleSearch = function () {
        $('.btn-search').on('click', function () {
            var data = $("#BlogsSearchForm").serializeArray();
            var url = config.url + "/blogs";
            var params = {};
    ...
    var handleLoadmore = function () {
        $('#load-more-button').on('click', function () {
            ...
            $(this).html('<i class="fa fa-spinner fa-spin fa-2x fa-fw"></i><span class="sr-only">Loading...</span>');
             ...
             var query = $.param(params);
              var action = config.url + '/get_blogs?page=' + Page;
             if (!jQuery.isEmptyObject(params)) {
                 action = config.url + '/get_blogs?page=' + Page + '&' + query;
             }
                ...
                success: function (data) {
                    ...
                    if (data.type == 'success') {
                        if (data.data.articles != "") {
                            $('#blog-items').append(data.data.articles);
                            Page++;
                        } else {
    ...
    var handleSubmit = function () {
        ...
        $('#CommentForm').submit(function () {
            var action = config.url + '/blogs/comments';
